...
static ::_pb::Metadata file_level_metadata_Bbb_2eproto[2];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_Bbb_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_Bbb_2eproto = nullptr;

const uint32_t TableStruct_Bbb_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_Bbb_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\tBbb.proto\"\321\001\n\rSimpleMessage\022\n\n\002id\030\001 \001("
  ...
  ;
static ::_pbi::once_flag descriptor_table_Bbb_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_Bbb_2eproto = {
    false, false, 266, descriptor_table_protodef_Bbb_2eproto,
    "Bbb.proto",
    &descriptor_table_Bbb_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_Bbb_2eproto::offsets,
    file_level_metadata_Bbb_2eproto, file_level_enum_descriptors_Bbb_2eproto,
    file_level_service_descriptors_Bbb_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_Bbb_2eproto_getter() {
  return &descriptor_table_Bbb_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_Bbb_2eproto(&descriptor_table_Bbb_2eproto);
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SimpleMessage_Type_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_Bbb_2eproto);
  return file_level_enum_descriptors_Bbb_2eproto[0];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata SimpleMessage_HeaderItem::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Bbb_2eproto_getter, &descriptor_table_Bbb_2eproto_once,
      file_level_metadata_Bbb_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata SimpleMessage::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Bbb_2eproto_getter, &descriptor_table_Bbb_2eproto_once,
      file_level_metadata_Bbb_2eproto[1]);
}
